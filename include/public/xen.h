...
#define __HYPERVISOR_do_iwmmxt_op       40
#define __HYPERVISOR_set_pirq_type      41
...
typedef struct shared_info {
	...
	unsigned long vdma_pending[sizeof(unsigned long)];
	unsigned long vdma_mask[sizeof(unsigned long)];
