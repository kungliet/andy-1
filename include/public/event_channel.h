 ...
 * [ 7: 0] Trigger Type
 * [11: 8] Status
 * [31:12] Guest Defined Flags
 */
#define PIRQF_TRIGGER_NONE		(0x00000000)
#define PIRQF_TRIGGER_RISING_EDGE	(0x00000001)
#define PIRQF_TRIGGER_FALLING_EDGE	(0x00000002)
#define PIRQF_TRIGGER_BOTH_EDGE		(0x00000003)
#define PIRQF_TRIGGER_HIGH_LEVEL	(0x00000004)
#define PIRQF_TRIGGER_LOW_LEVEL		(0x00000008)
#define PIRQF_TRIGGER_PROBE		(0x00000010)
