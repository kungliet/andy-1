...
extern long arch_memory_op(int op, GUEST_HANDLE(void) arg);
    ...
    unsigned long gmfn)
{
    ...
    {
        DPRINTK(3,"Domain %u page number %lx invalid\n",
                d->domain_id, mfn);
        return 0;
    }
    ...
    {
        DPRINTK(3,"Bad page free for domain %u\n", d->domain_id);
        return 0;
    }

    if ( test_and_clear_bit(_PGT_pinned, (unsigned long *)&page->u.inuse.type_info) )
